...
valor_inicial = cinematica.robot_IRB2600(grafica, posicion_inicial)
valor_deseado = valor_inicial @ cinematica.matriz_traslacion_z(200) @ cinematica.matriz_traslacion_x(50)
print(valor_inicial)
print(valor_deseado)
...
Matriz_TH = cinematica.robot_IRB2600(grafica, posiciones)
